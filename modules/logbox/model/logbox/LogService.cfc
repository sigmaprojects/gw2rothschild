...
<cfcomponent output="false" singleton>
	...
	<cffunction name="init" hint="Constructor" access="public" returntype="LogService" output="false">
		...
		<cfscript>
			// get module settings
			instance.logSettings = arguments.configBean.getKey("modules").logbox.settings.logboxLogs;
			// retrieve DAO
			instance.dao = arguments.injector.getInstance("#ucase(instance.logSettings.adapter)#_DAO@logboxlogs");
			// Logger
