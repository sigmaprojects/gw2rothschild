...
Author     :	Luis Majano
Description :
	The DAO implementation for the logbox viewer for PostgresSQL
----------------------------------------------------------------------->
<cfcomponent output="false" implements="ILogDAO" extends="AbstractDAO">

	<!--- Constructor --->
	<cffunction name="init" hint="Constructor" access="public" returntype="POSTGRES_DAO" output="false">
    ...
    <cffunction name="getLogs" output="false" access="public" returntype="any" hint="Get the log files">
		...
		LIMIT #(arguments.startRow-1)+arguments.maxRow# OFFSET #arguments.startRow-1#
		</cfif>
		</cfquery>
