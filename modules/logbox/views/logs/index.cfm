...
<div class="sidebar">
	...
	<div class="small_box">
		<div class="header">
			<img src="#rc.root#/includes/images/settings.png" alt="History" width="24" height="24" />Logs Settings
		</div>
		<div class="body">
			<p>The following are the settings the Logs are configured with:</p>
...
<div class="main_column">
	<div class="box">
		...
		<div class="body">
		<p>This is the contents of the log table you configured.  You can page through it, search and also do dynamic filtering of the current viewable window.</p>
		...
		<div id="logFilterBar" style="margin-bottom:15px">
			<div>
				#html.startForm(action="logbox/logs")#
				<fieldset>
					<!--- Log Filter --->
