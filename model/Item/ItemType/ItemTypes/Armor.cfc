component persistent=true extends="gw2rothchild.model.Item.ItemType.ItemType" table="itemtype_armor" joincolumn="itemtype_id" discriminatorvalue="Armor" accessors=true
	...
	property name="infusionslots"
		...
		linktable="itemtype_armor_infusionslot_jn"
	...
	property name="itemattributes"
		...
		linktable="itemtype_armor_itemattribute_jn"
...
*/
	public string function _getItem_Type() { return 'Armor'; }
